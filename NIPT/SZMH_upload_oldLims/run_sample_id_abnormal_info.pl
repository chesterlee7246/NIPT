...
{
           #MAPQ60_Fbin_GC_All_MicroInDel_ZScore_FLasso_Extract_Abnormal.txt
 if($file=~/MAPQ60_Fbin_GC_Per_MicroInDel_ZScore_FLasso_Extract_Abnormal.txt$/)
 {
  my $out=$dir."/".$file;
  ...
  my $s1=$path."/run_sample_id_abnormal_info.py";
