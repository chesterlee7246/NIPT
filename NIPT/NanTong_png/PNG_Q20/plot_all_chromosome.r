...
plot(x,y,ylim=c(-9,9),xaxt="n",yaxt="n",xlab="Chromosome",ylab="",main="",cex.main=3,cex.lab=2,xaxs = "i", yaxs = "i",bty="l")
axis(2,at=c(-9,-6,-3,0,3,6,9),label=c(-9,-6,-3,0,3,6,9),cex.axis=2,font.axis=2)
