...
# if(-e "$p2/scatter1_new_xy_height.R" ){
# system("Rscript $p2/scatter1_new_xy_height.R $name $to $title $INDEX");}
 if(-e "$p2/scatter1_new_xy.R" ){
 system("$rscript $p2/scatter1_new_xy.R $name $to $title $INDEX > $condition");}
 if(-e "$p2/scatter1_new_no_xy.R"){
