...
if($#info>=1){
 ...
 system("perl $p1/5.Report_CNV_Info.pl $MF");

# system("perl $p1/ClinGen_Annotation.pl $p1/ClinGen_gene_curation_list_GRCh37.tsv $MF");
system("perl $p1/ClinGen_new_Annotation.pl $p1/ClinGen_gene_curation_list_GRCh37.tsv $MF");
}
