...
#               geom_hline(yintercept = seq(1,7,1),color='grey',linetype="dotted",size=0.2)
                ...
                geom_hline(aes(yintercept=2.2), colour="#606060", linetype="dotdash",size=0.2)+
                geom_hline(aes(yintercept=1.8), colour="#606060", linetype="dotdash",size=0.2)+
                geom_hline(aes(yintercept=0.2), colour="grey", linetype="dotted",size=0.2)+
                geom_hline(aes(yintercept=0.8), colour="grey", linetype="dotted",size=0.2)
