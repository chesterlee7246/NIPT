...
class Pipeline():
    ...
    def normal_pip(self):
        os.system("perl "+self.pip_dir+"/CHD-YanFa_10kb_40K/parallel_logRR.pl "+self.indir+" "+self.pip_dir+"/CHD-YanFa_10kb_40K/LOGRR")
        if self.ycm:
            os.system("perl "+self.pip_dir+"/CHD-YanFa_10kb_40K/YCM/get_YCM.pl "+self.indir)
            os.system("bash "+self.pip_dir+"/CHD-YanFa_10kb_40K/YCM/YCM/scripts/batch_YCM.sh "+self.indir+" "+self.indir)
        os.system("perl "+self.pip_dir+"/CHD-YanFa_10kb_40K/Auto_DNAcopy_BreakPoints.pl "+self.indir+" "+self.pip_dir+"/CHD-YanFa_10kb_40K/BreakPoints "+self.pip_dir+"/CHD-YanFa_10kb_40K/DatabaseAnn")
    ...
    def plugin_report(self, report_date=None):
        ...
        os.system("perl "+self.pip_dir+"/CHD-YanFa_10kb_40K/create_report_html.pl " + self.indir+" " + self.pip_dir+"/CHD-YanFa_10kb_40K " + report_date + " "  + self.site )
...
"""
    ...
    def plot1(self):
        os.system("perl "+self.pip_dir+"/Auto_DNAcopy_BreakPoints_draw.pl "+self.indir+" "+self.pip_dir+"/CHD-YanFa_10kb_40K/BreakPoints "+self.pip_dir+"/CHD-YanFa_10kb_40K/DatabaseAnn")
        chmod_for_curator(self.indir)

    def plot2(self):
        os.system("perl "+self.pip_dir+"/Auto_DNAcopy_BreakPoints_onlyDraw.pl "+self.indir+" "+self.pip_dir+"/CHD-YanFa_10kb_40K/BreakPoints "+self.pip_dir+"/CHD-YanFa_10kb_40K/DatabaseAnn")
        chmod_for_curator(self.indir)
