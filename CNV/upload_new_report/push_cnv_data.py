...
(status,mosaic_png_base64)=commands.getstatusoutput("base64 -w 0 "+mosaic_png)
#print status
(status,cnv_png_base64)=commands.getstatusoutput("base64 -w 0 "+cnv_png)
...
#print json1['http_code']
    ...
    if chr_Y=="True":
        chr_y_name=sys.argv[24]
        chr_y_size=sys.argv[25]
        chr_y_desc=sys.argv[26]
        chr_y_png=sys.argv[27]
        (status,chr_y_png_base64)=commands.getstatusoutput("base64 -w 0 "+chr_y_png)
